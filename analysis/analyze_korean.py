...
def get_evaluation2(test_df, y_pred, test_y, train_x, train_y, paeup_grid, keep_grid, fitted_model):
...
if __name__=="__main__":
    ...
    get_evaluation2(test_df, paeup_grid=paeup_grid, keep_grid=keep_grid, fitted_model = fitted_model
